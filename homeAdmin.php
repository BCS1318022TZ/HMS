  ...
  <div class="container-fluid">
    <div class="row content">
      ...
      <div class="col-sm-6">
        ...
        <span>
         <img src="img/prof.jpg"<?php echo '#'; ?> style="width: 30%; height: 130px;margin-left: 15%; border: 1px solid white;">
       </span>
       <form>
        <table align="center">
          <tr>
...
<div class="col-sm-9">
  <button type="submit" class="btn btn-success">
    <a href="editAdmin.php?id=<?php echo $r['emp_id'];?>" style="color: white">EDIT DATA</a>
  </button>
</div>
</div>
</div>
